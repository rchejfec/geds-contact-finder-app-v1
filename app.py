...
# --- NEW: Function to prepare the Excel file for download ---
def to_excel(df):
...
def load_and_process_data(db_path):
    ...
    # Add the numbered display name as a new column
...
if not df_master.empty:
    ...
    if not df_filtered.empty:
        ...
        # Use our new helper function to prepare the data for download
    ...
    st.warning("Could not load data. Please ensure master_contacts.db is available.")
